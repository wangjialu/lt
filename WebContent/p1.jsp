...
<body>
	<table>
		<tr>
			<td>
			<table id="pdata" class="easyui-datagrid" title="产品目录表" style="width:400px;height:500px"
			data-options="fitcolumns:'true',rownumbers:'true',toolbar:'#toolbar',singleSelect:true,collapsible:true,pagination:true,method:'post'">
			<thead>
				<tr>
			...
			<td>
			<table id="mdata" class="easyui-datagrid" title="厂家价格表" style="width:500px;height:500px"
			data-options="fitcolumns:'true',toolbar:'#toolbar1',singleSelect:true,collapsible:true,pagination:true">
			<thead>
				<tr>
					<th data-options="field:'manufacturer_id',width:50">序号</th>
